			...
			<div class="login-screen">
				<div class="login-icon">
					...
					<div class="login-form">
					 <form id="defaultForm" method="get"  action="login.do">
...
<!-- 						<div class="input-group">
						...
						<div class="form-group">
							<input type="password" class="form-control login-field"
								placeholder="Password" name="userPw" /> <label
								class="login-field-icon fui-lock" for="userPw"></label>
						</div>
						
						<button class="btn btn-primary btn-lg btn-block" type="submit">登&nbsp;&nbsp;录</button>
						<a class="login-link" href="#">还没注册？前去注册</a>
						</form>
					</div>
